...
<?php if( (!$this->input->post()) || ($error) ): ?> 
	...
	<form name="edit_company" class="add_form" action="<?=$_SERVER['PHP_SELF']?>" method="post">
		...
		<?php //=============================================================//
			...
			//=============================================================// ?>
		<div class="db_row">
			<label for="company-address">Name</label>
		...
		<input type="submit" name="action" value="Update Company" />
