...
class Admin_Delete extends MY_Controller
{
	...
	var $page = 'delete';
	var $title = 'Game Series >> Delete Item';
	...
	/**
	 * Display the delete interface for the game series.
	 */
	function id( $id = NULL )
	{
	...
	function _process_post()
	{
		...
		// Delete the game series from table.
		$results = $this->table_model->delete_gameseries(
			$this->input->post('id')
		);
		if( $this->has_error() ) return;
		
		// The item was deleted successfully.
		$this->set_results( TRUE, 'The game series "'.$this->input->post('name').'" has been deleted.' );
...
/* End of file gameseries/admin_delete.php */
/* Location: ./application/controllers/gameseries/admin_delete.php */
