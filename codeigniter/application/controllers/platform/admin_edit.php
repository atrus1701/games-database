...
class Admin_Edit extends MY_Controller
{
	...
	/**
	 * Display the update interface for the platform.
	 */
	function id( $id = NULL )
	{
	...
	function _process_post()
	{
		...
		// Update the platform.
		$result = $this->table_model->update_platform(
			$this->input->post('id'),
		...
		// Store the platform's id.
		$id = $this->input->post('id');
		$this->add_content( 'id', $id );

		// The platform was successfully updated.
		$this->set_results( TRUE, 'The Platform "'.$this->input->post('name').'" has been updated.' );
...
/* End of file platform/admin_edit.php */
/* Location: ./application/controllers/platform/admin_edit.php */
