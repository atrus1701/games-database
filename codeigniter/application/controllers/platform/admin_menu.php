...
class Admin_Menu extends MY_Controller
{
	...
	/**
	 * Display the admin menu interface for the platform.
	 */
	function index()
	{
...
/* End of file platform/admin_menu.php */
/* Location: ./application/controllers/platform/admin_menu.php */
