...
class Admin_Delete extends MY_Controller
{
	...
	/**
	 * Display the delete interface for the region.
	 */
	function id( $id = NULL )
	{
	...
	function _process_post()
	{
		...
		// Delete the region from table.
		$results = $this->table_model->delete_region(
			$this->input->post('id')
		);
		if( $this->has_error() ) return;
		
		// The item was deleted successfully.
		$this->set_results( TRUE, 'The region "'.$this->input->post('name').'" has been deleted.' );
...
/* End of file region/admin_delete.php */
/* Location: ./application/controllers/region/admin_delete.php */
