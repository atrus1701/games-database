...
class Item extends MY_Controller
{
	...
	/**
	 * Displays game that matches the id.
	 */
	function id( $id = NULL )
	{
		...
		$results = $this->table_model->get_game_for_item_view( $id );
		if( !$this->has_error() )
		{
...
/* End of file game/item.php */
/* Location: ./application/controllers/game/item.php */
